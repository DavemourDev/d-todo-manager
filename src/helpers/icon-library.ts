...
import { faCalendar, faCalendarCheck, faCalendarTimes, faCheckCircle, faCheckSquare, faCircle, faCoffee, faExchangeAlt, faEye, faEyeSlash, faMinusSquare, faPlusSquare, faSortAlphaDownAlt, faSortAlphaUpAlt, faSortNumericDownAlt, faSortNumericUpAlt, faSquare, faTrash, faTrashAlt } from '@fortawesome/free-solid-svg-icons'
